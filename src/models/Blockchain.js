...
class Blockchain {
  ...
  // queries confirmed transactions and returns it
  ...
  // get confirmed transactions and querries with transactionHash
  ...
  // gets transactions by transaction address
  getTransactionsByAddress(address) {
    const confirmedTransactions = this.getConfirmedTransactions();
    return confirmedTransactions.filter(t => t.from === address || t.to === address);
  }

  // generates and returns a pending block
  getMiningJob() {
